...
public class Group13 {
	...
	private static String[] readInData(final String inputFileName) {
	...
	// YOUR SORTING METHOD GOES HERE: (you may call other methods and use other
	// classes).
	private static void sort(final String[] toSort) {
		ftlSort(toSort);
	}
	...
	/*
	 * private static long getBin(long i) { return i >> 59; }
	 * 
	 * private static long getValue(long i) { return (i >> 29) & 0x3FFFFFFF; }
	 * 
	 * private static int getIndex(long i) { return (int) (i & 0x1FFFFFFF); }
	 */
	...
	private static void writeOutResult(final String[] sorted,
